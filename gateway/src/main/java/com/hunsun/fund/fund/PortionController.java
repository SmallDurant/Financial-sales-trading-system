...
public class PortionController {
    ...
    public Result createPortion(
        ...
        if(res == -1){
            Boolean res1 = portionService.updatePositionPortion(userId, accountId, fundId, portion);
            if(res1){
            ...
            //Boolean r = logService.AddLogRecord(1L,7,"更新了持仓的信息", LocalDateTime.now());
            return Result.success("创建份额成功");
        }
